...
//             Integer MOVE = number.divide(olDnumber).intValue()*150;
    ...
    public static void main(String[] args) {
        String inputFilePath = "C:\\Users\\Administrator\\Desktop\\tmp\\1.jpg";
        String outFilePath = "C:\\Users\\Administrator\\Desktop\\tmp\\2.jpg";
        ...
        try {
            ...
            /*int x[]={860,650,300,1700};
            int y[]={20,20,1000,1000};
            ImageUtils.cutPolygon_Image(inputFilePath, outFilePath,x,y,4);*/
            ...
            //添加文字水印
            //ImageUtils.textWatermarking_Image(inputFilePath, outFilePath, "苏婉艳版权所有", -45, 80, 80);
